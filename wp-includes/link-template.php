...
function get_adjacent_post_link( $format, $link, $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
	...
	if ( ! $post ) {
		...
		$string = '<a class="fasc-button fasc-size-medium" href="' . get_permalink( $post ) . '" rel="'.$rel.'">';
		$inlink = str_replace( '%title', $title, $link );
		$inlink = str_replace( '%date', $date, $inlink );
		$inlink =  '<span class="story-title">'.$inlink.'</span>';
		if($rel=='prev') $inlink = '<i class="fa fa-chevron-circle-left amcust"></i>'.$inlink;
		if($rel=='next') $inlink .= '<i class="fa fa-chevron-circle-right amcust"></i>';
