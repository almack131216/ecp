...
function calendar_month() {
	return "<style>.embed-container-month { margin-top: 40px; position: relative; padding-bottom: 80% !important; height: 0; overflow: hidden; max-width: 100%; } .embed-container-month iframe, .embed-container-month object, .embed-container-month embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container-month'><iframe src='https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%23FFFFFF&src=englishcollege.cz_3539333133303038363937%40resource.calendar.google.com&color=%23875509&ctz=Europe%2FPrague' style='border-width:0' frameborder='0' scrolling='no'></iframe></div>";
}
add_shortcode( 'calendar_month', 'calendar_month' );


function calendar_agenda() {
	return "<style>.embed-container-agenda { position: relative; height: 90%; xxmin-height: 430px; overflow: hidden; max-width: 100%; } .embed-container-agenda iframe, .embed-container-agenda object, .embed-container-agenda embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container-agenda'><iframe src='https://calendar.google.com/calendar/embed?showTitle=0&showNav=0&showDate=0&showPrint=0&showTabs=0&showCalendars=0&mode=AGENDA&height=600&wkst=2&bgcolor=%23FFFFFF&src=englishcollege.cz_3539333133303038363937%40resource.calendar.google.com&color=%23875509&ctz=Europe%2FPrague' style='border-width:0; height:100%;background-color:grey;font-weight:bold!important' height='100%' frameborder='0' scrolling='no'></iframe></div>";
}
